...
def make_groups():
    if Globals.TEMP_VARS['cur_game']:
        return (
            'start', 1, 1, 'income', 1, 'chance', 2, 2, 'chest', 2, 'jail', 3, 3, 'income', 3, 'chance', 4, 4, 'chest',
            4,
            'skip', 5, 'tax', 5, 5, 'chance', 6, 'chest', 6, 6, 'gotojail', 7, 'income', 7, 7, 'chance', 8, 'chest', 8,
            8)
    else:
        return ('start', 1, 'chest', 1, 'tax', 'railroad', 2, 'chance', 2, 2, 'jail', 3, 'service', 3, 3, 'railroad', 4,
                'chest', 4, 4, 'skip', 5, 'chance', 5, 5, 'railroad', 6, 6, 'service', 6, 'gotojail', 7, 7, 'chest', 7,
                'railroad', 'chance', 8, 'tax', 8)
...
def make_chests_and_chances(type):
    if type == 'chests':
        if Globals.TEMP_VARS['cur_game']:
            return ['free_jail', 'goto 34', 'goto 12', 'goto 12', 'goto 39', 'income -1000', 'goto 6', 'income 20000',
                    'income 10000', 'income 10000', 'income 5000', 'income -1000', 'income 20000', 'take_chance',
                    'income -20000', 'income 10000', 'income 1000', 'goto_forward -3', 'income -5000', 'goto 14',
                    'income 20000', 'goto_forward 2', 'income 20000', 'repair 5000 10000', 'goto 0', 'goto_jail',
                    'income -20000', 'goto 9', 'goto 39', 'income -5000', 'goto 24', 'income -1000', 'goto 4',
                    'goto_forward -3', 'income -5000', 'goto 14', 'income 10000', 'goto_forward 2', 'income 20000',
                    'repair 5000 10000', 'income 20000', 'goto_jail', 'income -20000', 'goto 9', 'income -20000',
                    'income -5000', 'goto 24', 'income -1000']
        else:
            return ['goto 0', 'repair 40 115', 'birthday 10', 'income 100', 'income 10', 'income -50', 'free_jail',
                    'goto_jail', 'income -50', 'income 100', 'income 50', 'income 20', 'income -100', 'income 200',
                    'income 25', 'income 100']
    else:
        if Globals.TEMP_VARS['cur_game']:
            return ['free_jail', 'goto 34', 'goto 12', 'goto 12', 'goto 39', 'income -1000', 'goto 6', 'goto 17',
                    'goto 19', 'goto 4', 'goto_forward 2', 'goto 0', 'goto 29', 'goto 28', 'goto 9',
                    'repair 5000 10000', 'income -5000', 'goto 24', 'goto_forward -3', 'income -1500', 'goto_jail',
                    'goto_forward 2', 'income 20000', 'repair 5000 10000', 'goto 0', 'goto_jail', 'income -20000',
                    'income -5000', 'goto 39', 'income -5000', 'goto 24', 'income -1000', 'free_jail', 'goto 34',
                    'goto 12', 'goto 12', 'goto 39', 'income -1000', 'goto 6', 'goto 17', 'goto 19', 'goto 4',
                    'goto_forward 2', 'goto 0', 'goto 29', 'goto 28', 'goto 9', 'repair 5000 10000']
        else:
            return ['goto_service', 'goto_forward -3', 'goto 0', 'goto_railroad', 'repair 25 100', 'goto 11',
                    'goto_jail', 'goto 39', 'goto_railroad', 'income 150', 'income -15', 'goto 5', 'goto 24',
                    'income 50', 'pay_each 50', 'free_jail']
